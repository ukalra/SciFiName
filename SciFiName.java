...
public class SciFiName   
{
    ...
    public static void main()
    {
        ...
        System.out.println("SciFi Name:");
        String fName = (firstName.substring(0, 3) + lastName.substring(0, 2));
        String rName = fName.substring(0, 1).toUpperCase() + fName.substring(1);
        String lName =(city.substring(0, 2) + school.substring(0, 3));
        String sName = lName.substring(0, 1).toUpperCase() + lName.substring(1);
        double num = Math.random() * (firstName.length()-1) + 1;
        String rel1 = (relativeName1.substring((int)num, relativeName1.length()));
        double num2 = Math.random() * (lastName.length()-1) + 1;
        String rel2 = (relativeName2.substring((int)num2, relativeName2.length()));
        System.out.println(rel1+rel2);
        System.out.println("Hello "+ rName + " " + sName + " of " + rel1 + rel2 + ". Welcome!");
